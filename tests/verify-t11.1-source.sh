...
printf '%s\n' '{"schema":1,"runtime":"MLE_JAVASCRIPT","teaVMVersion":"0.15.0","compilerRelease":11,"targetType":"JAVASCRIPT","moduleType":"ES2015","optimizationLevel":"ADVANCED","minifying":true,"profile":"simulation-engine-headless","inputBytecodeSha256":"8cae68323d62edfa56299569d15763e6dbd24974dc3a24f3ae64961071920d8b","mochaBytecodeSha256":"6a611ad85d09eb0fa16996cefc891e9e7dd0c7f827eaa7e93f01ccff1726bd97","authority":{"bytes":1163182,"sha256":"06ac33331d9a9158d63fba2da4688ad5d3ff30c316b4c20c09e38d77d3fdebf0"},"tablePack":{"bytes":180272,"sha256":"058cd0df9444131b356762a096fd422d5131ac3aea91163aee056e8ad4965b44"},"iwadSha256":"7323bcc168c5a45ff10749b339960e98314740a734c30d4b9f3337001f9e703d"}' >"$tmp/mle.json"
node "$root/scripts/t11.1-deployment-manifest.mjs" "$tmp/ledger" "$tmp/manifest.json" "$tmp/mle.json"
jq -e '(.domains|map(.domain)==["schema","seed","engine","rest"] and map(.order)==[1,2,3,4] and all(.files==1)) and .mleArtifact.runtime=="MLE_JAVASCRIPT" and .mleArtifact.authority.bytes==1163182 and (.javaArtifact|not)' "$tmp/manifest.json" >/dev/null
