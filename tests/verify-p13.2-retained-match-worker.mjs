...
assert.match(worker, /c_checkpoint_min_tics constant pls_integer:=497/);
assert.match(worker, /c_checkpoint_max_tics constant pls_integer:=512/);
assert.match(worker, /c_checkpoint_probe_tics constant pls_integer:=16/);
...
assert.match(worker, /if mod\(p_tic,c_checkpoint_probe_tics\)=0 then/);
assert.match(worker, /p_tic-l_last_checkpoint_tic>=c_checkpoint_min_tics/);
assert.match(worker, /p_tic-c_checkpoint_max_tics/);
