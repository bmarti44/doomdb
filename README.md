...
| P12.0 | Active playability gate | The retained renderer worker passes at 15.671/17.590 ms p50/p95. The 191 KB simulation catalog and BLOCKMAP collision kernel pass 270/270 real moves (124 contacts) at 0.165/0.734 ms p50/p95; actors, persistence, and public integration remain. |
...
root byte-for-byte. A SHA-verified 191,381-byte worker catalog now retains all
681 BSP nodes, 682 subsector owners, 1,175 collision lines, 182 sectors, and the
movement matrix plus BLOCKMAP. Its BSP locator matches 270/270 SQL cases, and
