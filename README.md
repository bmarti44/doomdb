...
| P12.0 | Active playability gate | The retained renderer worker passes at 15.671/17.590 ms p50/p95. Simulation now has transaction/fence gates and a 164 KB retained catalog with 270/270 BSP-location plus 1,152/1,152 exact movement parity; full collision, actors, persistence, and public integration remain. |
...
root byte-for-byte. A SHA-verified 163,984-byte worker catalog now retains all
681 BSP nodes, 682 subsector owners, 1,175 collision lines, 182 sectors, and the
movement matrix; its BSP locator matches 270/270 SQL cases. Playability requires
