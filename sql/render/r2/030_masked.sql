...
with
pose as (
  select session_row.session_token,player.player_id,
...
screen_pixels as (
  select screen_columns.column_no,screen_rows.row_no,
...
solid_depths as (
  select session_token,column_no,min(hit_t) wall_depth
  from hit_windows
