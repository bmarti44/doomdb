  ...
  for t in (
    select column_value table_name
      from table(sys.odcivarchar2list(
        ...
        'DOOM_MATCH_ROUTE_TRACE','DOOM_MATCH_WORKER_CONTROL','DOOM_MATCH_CHECKPOINT','DOOM_MATCH_FRAME','DOOM_MATCH_COMMAND','DOOM_MATCH_TIC','DOOM_MATCH_MEMBER','DOOM_MATCH',
