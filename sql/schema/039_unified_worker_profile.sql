...
begin
  ...
  add_column('ACTOR_TIC_US');
  add_column('PROJECTILE_US');
  add_column('PROJECTILE_SETUP_US');
  add_column('PROJECTILE_WALL_US');
  add_column('PROJECTILE_TARGET_US');
  add_column('PROJECTILE_IMPACT_US');
  add_column('PROJECTILE_COUNT');
  add_column('PROJECTILE_TARGET_CHECKS');
  add_column('CHASE_US');
  add_column('ACTOR_LOOP_US');
  add_column('DELTA_ENCODE_US');
  add_column('COMMAND_ENCODE_US');
  add_column('APPLY_US');
  add_column('WORLD_APPLY_US');
  add_column('DELTA_APPLY_US');
  add_column('DELTA_DECODE_US');
  add_column('DELTA_VALIDATE_US');
  add_column('DELTA_WORLD_DML_US');
  add_column('DELTA_ACTOR_DML_US');
  add_column('DELTA_EVENT_DML_US');
  add_column('DELTA_FRONTIER_DML_US');
  add_column('STATE_US');
