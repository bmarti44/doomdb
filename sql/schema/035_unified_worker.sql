...
create table doom_worker_result (
  ...
  actor_tic_us number,
  projectile_us number,
  projectile_setup_us number,
  projectile_wall_us number,
  projectile_target_us number,
  projectile_impact_us number,
  projectile_count number,
  projectile_target_checks number,
  chase_us number,
  actor_loop_us number,
  delta_encode_us number,
  command_encode_us number,
  apply_us number,
  world_apply_us number,
  delta_apply_us number,
  delta_decode_us number,
  delta_validate_us number,
  delta_world_dml_us number,
  delta_actor_dml_us number,
  delta_event_dml_us number,
  delta_frontier_dml_us number,
  state_us number,
  render_us number,
